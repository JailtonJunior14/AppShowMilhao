...
namespace AppShowMilhao
{
    public partial class MainPage : ContentPage
    {
        ...
        public MainPage()
        {
            ...
            Stream track = FileSystemAclExtensions.openAppPackageFileAsync("0.mp3").Result;
            AudioManager.Current.CreatePlayer(track).Paly();
        }
        ...
        private async void Button_Clicked_Proxima(object sender, EventArgs e)
        {
            ...
            } else
            {
                ...
                await DisplayAlert("Errou!!!!!", "Voce perdeu", "OK");
                premio = 0;
                pergunta_count = 1;
                avanca_pergunta();
